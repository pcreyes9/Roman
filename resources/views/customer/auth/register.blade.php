...
<div class="items-center justify-center flex mt-5">
    <div class="bg-white mx-5 sm:px-10 px-5" style="width: 45rem">
        <div class="flex intro-y items-center  mt-5">
...
<div class=" items-center justify-center flex" >
    <div class="intro-y py-10 bg-white mx-5 sm:px-10 sm:py-10" style="width: 45rem">
        <div class="px-1 mt-0">
        ...
        <div class="px-5 sm:px-5 mt-10 pt-10 border-t border-slate-200/60 dark:border-darkmode-400">
