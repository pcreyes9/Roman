...
<div class="my-3">
    <div class="grid grid-cols-12">
        ...
        <div class="col-span-12 lg:col-span-3 2xl:col-span-2 flex lg:block flex-col-reverse ">
            <div class="sticky top-10 right-10 box sm:ml-1 sm:mr-5">
        ...
        <div class="col-span-12 lg:col-span-9 2xl:col-span-10">
            <!-- BEGIN: Product List -->
            <div class="intro-y mt-5 sm:mt-0">
                
                <div class="">
                    <div class="grid grid-cols-12 gap-4 sm:gap-1 intro-y max-width place-items-center">
