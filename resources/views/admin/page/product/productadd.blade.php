...
<div class="col-span-12 lg:col-span-8 2xl:col-span-9">
    ...
    <h2 class="intro-y text-xl font-medium mt-5 ml-6 sm:ml-6">
        Add Product
    </h2>
    <div class="intro-y">
                        ...
                        <div class="intro-y box col-span-12 lg:col-span-6">
                            ...
                            <div class="p-5">
                                <div>
                                    ...
                                    <input id="Name" name="name" type="text" placeholder="Product Name" class="form-control" value="{{old('name')}}" >
                                </div>
                                ...
                                <div class="grid grid-cols-12 gap-2  ">
                                    <div class="col-span-6 sm:col-span-12">
                                        ...
                                        <div class="input-group">
                                            <input  type="number" id="cprice" class="form-control" placeholder="Original Price" name="cprice" value="{{old('cprice')}}">
                                    ...
                                    <div class="col-span-6 sm:col-span-12">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="sprice" class="form-control" placeholder="Selling Price"  name="sprice" value="{{old('sprice')}}">
                                            <div class="input-group-text">
                                                PHP
                                            </div>
                                        </div>
                                ...
                                {{-- BBEGIN - Product Variant --}}
                                <div id="root">
                                    <div class="mb-2 mt-5">
                                        <button type="button" @click="createVariant" class="btn btn-outline-secondary">Enter variant</button>
                                    </div>
                        ...
                        <div class="intro-y box col-span-12 lg:col-span-6">
                            ...
                            <div class="p-5">
                                <div class="grid grid-cols-12 gap-2  ">
                                    ...
                                    <div class="col-span-12 lg:col-span-8 2xl:col-span-6">
                                        <label for="inventory" class="form-label">Weight</label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" placeholder="Weight"  name="weight" value="{{old('weight')}}">
                                            <div class="input-group-text">
                                                grams
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-span-12 lg:col-span-8 2xl:col-span-6">
                                        <label for="inventory" class="form-label">SKU</label>
                                        <div class="input-group">
